...
// Validate URL and check for suspicious patterns that might indicate data exfiltration
...
export async function fetchPageAsMarkdown(
  ...
  // Log fetch with any warnings (audit trail for potential exfiltration)
