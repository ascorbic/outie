/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 788f22a93bc4c9732dd06b2ceeda7ef7)
// Runtime types generated with workerd@1.20260111.0 2025-01-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "OutieSandbox" | "Orchestrator";
	}
	interface Env {
		ENVIRONMENT: "development";
		CF_ACCOUNT_ID: "14c4011b68b618c5b86f0aa053a834b3";
		...
		ORCHESTRATOR: DurableObjectNamespace<import("./src/worker").Orchestrator>;
		SANDBOX: DurableObjectNamespace<import("./src/worker").OutieSandbox>;
		AI: Ai;
	}
}
