/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b083838d540cb80e1a74eaacb7bbff5c)
// Runtime types generated with workerd@1.20260111.0 2025-01-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Outie" | "OutieSandbox";
	}
	interface Env {
		...
		ZAI_API_KEY: string;
		OUTIE: DurableObjectNamespace<import("./src/index").Outie>;
		SANDBOX: DurableObjectNamespace<import("./src/index").OutieSandbox>;
		REPOS: R2Bucket;
		AI: Ai;
	}
}
